...
<html>
	...
	<body>
        ...
        <div class="container">
            <br/> 
            <div class="pull-left">
                Diper Library - Preview HTML to DOC [ size paper A4 ]
            </div>
        ...
        <div id="printableArea">
            <page size="A4" style="background-color: black">
				<div class="panel panel-default">
					<div class="panel-body bg-primary"style="background-color: purple">
						<h4 class="text-center">KARTU ANGGOTA DIPER LIBRARY</h4>
						<br/>
						<div class="row">
							<div class="col-sm-8">
