...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i class="fa fa-plus" style="color:purple"> </i>  Tambah User
    </h1>
    <ol class="breadcrumb">
			    ...
			    <div class="box-body">
                    <form action="<?php echo base_url('user/add');?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="tgl_lahir" required="required" placeholder="Contoh : 2002-08-17">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>Telepon</label>
                                    <input id="uintTextBox" class="form-control" name="telepon" required="required" placeholder="Contoh : 089613069999">
                                </div>
                                <div class="form-group">
                                    <label>E-mail</label>
                                    <input type="email" class="form-control" name="email" required="required" placeholder="Contoh : dindacantik1@gmail.com">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="pull-right">
                            <button type="submit" class="btn btn-primary btn-md" style="background-color:green">Submit</button> 
                    </form>
