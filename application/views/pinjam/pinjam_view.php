...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i class="fa fa-edit" style="color:purple"> </i>  <?= $title_web;?>
    </h1>
    <ol class="breadcrumb">
  ...
  <section class="content" style="background-color: purple">
	<?php if(!empty($this->session->flashdata())){ echo $this->session->flashdata('pesan');}?>
	<div class="row">
	    <div class="col-md-12">
	        <div class="box box-primary">
                <div class="box-header with-border"style="background-color:black"><?php if($this->session->userdata('level') == 'Petugas'){ ?>
                    <a href="transaksi/pinjam"><button class="btn btn-primary"style="background-color:purple">
				<i class="fa fa-plus"> </i> Tambah </button></a><?php }?>
