...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/bglogin.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br>
  <div class="login-logo" >
    <a href="index.php" style="color: white;"><h1><b>Selamat Datang di Diper Library</b></h1></a></br>
  </div>
  <div id="tampilalert"></div>

  <!-- /.login-logo -->
  <div class="login-box-body" style="background-color: grey;  border:1px solid #216bbf;">
    ...
    <form action="<?= base_url('login/auth');?>" method="POST">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <button type="submit" id="loding" class="btn btn-primary btn-group-lg form_btn" style="background-color: black ;">Login</button>
