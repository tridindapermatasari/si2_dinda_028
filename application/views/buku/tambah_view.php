...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i class="fa fa-plus" style="color:purple"> </i>  <?= $title_web;?>
    </h1>
    <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>ISBN</label>
                                    <input type="text" class="form-control" name="isbn"  placeholder="Contoh ISBN : 967-107-8832-15-7">
                                </div>
                                <div class="form-group">
                                    <label>Judul Buku</label>
                                    <input type="text" class="form-control" name="title" placeholder="Contoh : Matematika Ilmu Yang Menyenangkan">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="thn" placeholder="Tahun Buku : 2015">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="jml" placeholder="Jumlah buku : 5">
                                </div>
